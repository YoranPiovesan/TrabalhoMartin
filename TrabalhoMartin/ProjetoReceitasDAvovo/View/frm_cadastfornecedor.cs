...
namespace ProjetoReceitasDAvovo.View    
{
    public partial class frm_fornecedores : Form
    {
        ...
        public PessoaFornecedor CadastrarFornecedor()
        {
            ...
            //povoando a lista PessoaFornecedor
            ...
            //condição feita para caso o usuário pressione o botão sem informar NomeEmpresa 
            ...
            {
              //  pessoaController.adicionarFornecedor(pessoaFornecedor);
